          ...
          children: [
            Row(
              children: [
                ...
                Text('${trails.title}', style: TextStyle(color: bgColor, fontWeight: FontWeight.bold))
              ],
            ),
            Column(
              children: [
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      Navigator.of(context).push(MaterialPageRoute(builder: (_)=>NewTrailsScreen(trails: trails)));
                    },
                    child: Text('Editar'),
                  ),
                ),
  ...
  void delete(BuildContext context) {
    showDialog(
      ...
      builder: (_) => AlertDialog(
        title: Text('Excluir'),
        content: Text('Confirmar a exclusão de ${trails.title}?'),
        actions: [
          TextButton(
            onPressed: (){
