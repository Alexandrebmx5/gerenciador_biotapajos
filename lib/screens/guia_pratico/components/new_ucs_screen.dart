...
import 'package:gerenciador_aquifero/screens/guia_pratico/components/image_field_ucs.dart';
import 'package:gerenciador_aquifero/stores/edit_ucs_store.dart';
import 'package:mobx/mobx.dart';

class NewUcsScreen extends StatefulWidget {

  NewUcsScreen({this.ucs});

  final Ucs ucs;

  @override
  _NewUcsScreenState createState() => _NewUcsScreenState(ucs);
}

class _NewUcsScreenState extends State<NewUcsScreen> {

  _NewUcsScreenState(Ucs ucs)
      : editing = ucs != null,
        store = EditUcsStore(ucs ?? Ucs());

  bool editing;

  final EditUcsStore store;

  @override
  void initState() {
    super.initState();

    when((_) => store.saveUcs == true, () {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Ucs', style: TextStyle(color: secondaryColor)),
        backgroundColor: primaryColor,
        actions: [
          Observer(builder: (_) {
            return Padding(
