...
import 'package:gerenciador_aquifero/screens/info_and_atualidades/components/image_field_atualidade.dart';
import 'package:gerenciador_aquifero/stores/edit_presently_store.dart';
import 'package:mobx/mobx.dart';

class NewAtualidadesScreen extends StatefulWidget {

  NewAtualidadesScreen({this.presently});

  final Presently presently;

  @override
  _NewAtualidadesScreenState createState() => _NewAtualidadesScreenState(presently);
}

class _NewAtualidadesScreenState extends State<NewAtualidadesScreen> {

  _NewAtualidadesScreenState(Presently presently)
      : editing = presently != null,
        store = EditPresentlyStore(presently ?? Presently());

  bool editing;

  final EditPresentlyStore store;

  @override
  void initState() {
    super.initState();

    when((_) => store.savePresently == true, () {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Atualidades', style: TextStyle(color: secondaryColor)),
        backgroundColor: primaryColor,
        actions: [
          Observer(builder: (_) {
            return Padding(
