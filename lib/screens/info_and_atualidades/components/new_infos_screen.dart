...
import 'package:gerenciador_aquifero/screens/info_and_atualidades/components/image_field_infos.dart';
import 'package:gerenciador_aquifero/stores/edit_infos_store.dart';
import 'package:mobx/mobx.dart';

class NewInfosScreen extends StatefulWidget {

  NewInfosScreen({this.infos});

  final Infos infos;

  @override
  _NewInfosScreenState createState() => _NewInfosScreenState(infos);
}

class _NewInfosScreenState extends State<NewInfosScreen> {

  _NewInfosScreenState(Infos infos)
      : editing = infos != null,
        store = EditInfosStore(infos ?? Infos());
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Informes', style: TextStyle(color: secondaryColor)),
        backgroundColor: primaryColor,
        actions: [
          Observer(builder: (_) {
            return Padding(
